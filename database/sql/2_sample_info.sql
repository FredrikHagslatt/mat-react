...
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (22, 'Tomatsoppa', 'https://www.koket.se/anders_leven/soppor_och_grytor/gronsaker/tomatsoppa_med_basilikatoast/?fbclid=IwAR2pWyTsjepaonxuk0UIfIugu5YBtX-dN2BA7gYeTw1yLnZyFQ7b7hWcFsI', 64, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (17, 'Kräftstjärtspasta', 'https://www.arla.se/recept/morotspasta-med-kraftor/', 51, 'External');
INSERT INTO public.recipes (id, name, queue_pos, type) VALUES (23, 'Tacopaj', 49, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (27, 'Enchiladas', 'https://www.santamariaworld.com/se/recept/enchiladas-med-kyckling/?fbclid=IwAR0xpPIemDLKOkArF5kHfIfT5aZYP53OgWB_UaAM5FPPBCljmAQ2gAsoYTA', 35, 'External');
INSERT INTO public.recipes (id, name, queue_pos, type) VALUES (39, 'Fiskpinnar med stuvad spenat', 16, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (20, 'Krämig kycklinggryta med bacon och soltorkade tomater', 'https://www.tasteline.com/recept/kramig-kycklinggryta-med-kycklingbacon-och-soltorkade-tomater/', 13, 'External');
INSERT INTO public.recipes (id, name, queue_pos, type) VALUES (21, 'Thaisoppa', 11, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (28, 'Asiatisk kokosgryta med lax', 'https://www.tasteline.com/recept/asiatisk-kokosgryta-med-lax/', 7, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (13, 'Busenkel korvröra', 'http://matochmera.se/recepie.php?recepie_id=31348', 104, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (12, 'Fredrik hittar på något nytt', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', 98, 'External');
INSERT INTO public.recipes (id, name, url, image, queue_pos, type) VALUES (46, 'Flygande Jacob', 'https://www.ica.se/recept/flygande-jacob-717569/', 'flygande_jacob.jpg', 58, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (37, 'Laxsida i ugn', 'https://zeinaskitchen.se/hel-laxsida-i-ugn/', 34, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (45, 'Krämig svampkyckling', 'https://www.saltandlavender.com/creamy-mushroom-chicken/?fbclid=IwAR3o6VgU57vmQDUYdbrNOk-cYlYy0gNp_9mHPJCEdgKQwWdKPTwoiP4WmSo', 31, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (11, 'Karin hittar på något nytt', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', 28, 'External');
INSERT INTO public.recipes (id, name, url, image, queue_pos, type) VALUES (32, 'Vegetarisk lasagne', 'https://www.tasteline.com/recept/vegetarisk-lasagne-med-spenat-och-keso/', 'veg_lasagne.jpg', 2, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (24, 'Köttgryta', 'https://www.arla.se/recept/bygardens-kottgryta/?fbclid=IwAR3GeiH6b96FLRpUs8prXps7C7y2Za0BotG4rieKPqOtSbXagAW41WN_7N4', 10, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (26, 'Halloumipasta', 'https://www.ica.se/recept/kramig-pasta-med-halloumi-och-tomat-719023/?fbclid=IwAR1xArtwvt6rCF9gp3FWrgJiwSsQiEPIx_fEH2Ccvt2sqVCCO1erqeJcxT0', 6, 'External');
INSERT INTO public.recipes (id, name, url, image, queue_pos, type) VALUES (14, 'Korv Stroganoff med ris', 'https://www.ica.se/recept/korvstroganoff-med-ris-533512/', 'korv_stroganoff.jpg', 1, 'External');
INSERT INTO public.recipes (id, name, url, image, queue_pos, type) VALUES (36, 'Gulasch', 'https://www.tasteline.com/recept/gulaschsoppa-2/', 'gulasch.jpg', 4, 'External');
INSERT INTO public.recipes (id, name, url, queue_pos, type) VALUES (41, 'Köttfärssoppa', 'https://www.ica.se/recept/kottfarssoppa-587342/?fbclid=IwAR1qP4O4PhFaAYfJVEMTSIcj_iPnzrI5U1w39XHlA3bP0UmynbuaGhRKLYY', 3, 'External');
INSERT INTO public.recipes (id, name, url, image, queue_pos, type) VALUES (35, 'Falukorv i ugn', 'https://www.koket.se/morberg-lagar-husmanskost/per-morberg/falukorv-i-ugn-a-la-per-morberg/', 'falukorv_i_ugn.jpg', 0, 'External');
INSERT INTO public.recipes (name, url, image, type) VALUES ('Club sandwichtårta', 'https://www.ica.se/recept/smorgastarta-a-la-club-sandwich-714805/', 'club_sandwich_cake.jpg', 'External');
